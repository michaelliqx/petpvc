...
${UNCRUSTIFYBIN} -c /public/liqingxing/PET/ITK/InsightToolkit-5.0.1/Utilities/Maintenance/uncrustify_itk.cfg -l CPP -f ${file} | sed 's/  *##  */##/g' | sed 's/#  */#/g' > ${file}_uncrustify
...
/usr/bin/KWStyle -xml /public/liqingxing/PET/ITK/build/Utilities/KWStyle/ITK.kws.xml -v -o /public/liqingxing/PET/ITK/InsightToolkit-5.0.1/Utilities/KWStyle/ITKOverwrite.txt -gcc $file > ${KWERRORS}
...
if [ -f ${KWERRORS} ]; then
  ...
  if [ ${skipuncrustify} == "y" ]; then
    ${UNCRUSTIFYBIN} -c /public/liqingxing/PET/ITK/InsightToolkit-5.0.1/Utilities/Maintenance/uncrustify_itk.cfg -l CPP -f ${file} -o ${KWERRORS}_skip_uncrustify
  fi
